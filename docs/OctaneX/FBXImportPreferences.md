You can manage FBX import preferences by going to File \> Preferences \> Geometry Import \> FBX.

+-----------------------------------+-------------------------------------------------------+
| ![](images/NewItem_17.png)        | FBX import                                            |
|                                   |                                                       |
|                                   | ![](images/FBX_Import_Preferences_Fig01_SE_v2026.jpg) |
+-----------------------------------+-------------------------------------------------------+

Figure 1: FBX Import preferences
...
Merge Object Layers with the Same Name - If enabled, object layers with the same name but of different meshes will be merged to one object layer input.
