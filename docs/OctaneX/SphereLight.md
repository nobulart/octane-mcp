The Sphere Light is essentially a geometric sphere with a [Diffuse](javascript:void(0);) material that has the Emission properties activated (Figure 1). 

+-----------------------------------+---------------------------------------------+
| ![](images/NewItem_350.png)       | Sphere Light                                |
|                                   |                                             |
|                                   | ![](images/Sphere_Light_Fig01_SE_v2023.jpg) |
+-----------------------------------+---------------------------------------------+

Figure 1: The Sphere Light and it\'s associated parameters

### Sphere Light Parameters

Sphere Radius - Determines the size of the light source. The larger the source, the softer the shadows.
...
The Sphere Light can be added to a scene through the use of a Geometry Group node (Figure 2).

+-----------------------------------+---------------------------------------------+
| ![](images/NewItem_351.png)       | Geometry Group Node                         |
|                                   |                                             |
|                                   | ![](images/Sphere_Light_Fig02_SE_v2020.jpg) |
+-----------------------------------+---------------------------------------------+

Figure 2: Using the Geometry Group node to add a Sphere Light to a scene.
